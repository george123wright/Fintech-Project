...
const RISK_COLUMNS: MarketColumn[] = [
  { key: "sortino", label: "Sortino", align: "right", formatter: (row) => fmtNum(row.sortino) },
...
const RELATIVE_COLUMNS: MarketColumn[] = [
  { key: "upside_capture", label: "Upside Cap", align: "right", formatter: (row) => fmtNum(row.upside_capture) },
  { key: "downside_capture", label: "Downside Cap", align: "right", formatter: (row) => fmtNum(row.downside_capture) },
